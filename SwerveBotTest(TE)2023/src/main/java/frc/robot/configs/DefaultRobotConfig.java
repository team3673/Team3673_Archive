...
public class DefaultRobotConfig extends RobotConfig {
  ...
  // FIXME: update all CAN IDs and steer offsets (changed)
  ...
  private static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(232.29492491743042);
  ...
  private static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(77.60742338762292);
  ...
  private static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(52.64649023562215);
  ...
  private static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(164.0917977527013);
