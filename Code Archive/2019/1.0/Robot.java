...
public class Robot extends TimedRobot {
	...
	public void autonomousPeriodic() {
		...
		if (blackThree.get()){
			...
			// Set wrist to .35 (Hopefully this goes up?)
			theWrist.set(.5);
		...
		// If blackFour is pressed
			...
			// Set wrist to -.35 (Hopefully this goes down??)
			theWrist.set(-.5);
	...
	public void teleopPeriodic() {
		...
		// If blackFour is pressed
			...
			// Set the wrist to not move, with -0.19 for resistance so it won't fall
			theWrist.set(-0.17);
