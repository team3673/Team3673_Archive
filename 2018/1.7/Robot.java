...
public class Robot extends IterativeRobot {
	...
	public double latestDistance = encode.getDistance();
	...
	public double distance = count*distancePerRotation+latestDistance;
	...
	public void autonomousInit() {
		...
		encode.setDistancePerPulse(wheelDiameter*3.14159265358979323846264);
		//Double leftSpeed to prevent junk values
		leftSpeed = 0.0;
		//Double rightSpeed to prevent junk values
		rightSpeed = 0.0;
	...
	public void teleopPeriodic() {
		...
		encode.setReverseDirection(false);
			...
			// If neither the third or fifth red button are pressed
			else{
		...
		if(red.getTrigger() && !solToggle && !isExtended ){
			...
			// Boolean isForward says solenoids are forward
			isExtended = true;
			...
			// Boolean isForward says solenoids are in reverse
			isExtended = false;
